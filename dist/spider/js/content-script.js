...
var CollectProject = (function () {
    ...
    CollectProject.prototype.confirm = function (data, cb) {
        var box = ZreUtil.dialog("<form class=\"_zre-form\" onsubmit=\"return false\">\n        <input type=\"text\" name=\"url\" placeholder=\"\u7F51\u5740\" value=\"".concat(data.url, "\">\n        <input type=\"text\" name=\"title\" placeholder=\"\u6807\u9898\" value=\"").concat(data.title, "\">\n        <input type=\"text\" name=\"keywords\" placeholder=\"\u5173\u952E\u8BCD\" value=\"").concat(data.keywords, "\">\n        <input type=\"text\" name=\"logo\" placeholder=\"Logo\" value=\"").concat(data.logo, "\">\n        <textarea name=\"description\" placeholder=\"\u63CF\u8FF0\">").concat(data.description, "</textarea>\n        <button type=\"submit\">\u786E\u8BA4\u6536\u85CF</button>\n        <button type=\"reset\" class=\"_zre-dialog-close\">\u53D6\u6D88</button>\n    </form>"));
